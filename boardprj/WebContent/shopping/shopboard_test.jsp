		  		...
		  		for(int j=1+((i-1)*4);j<=4*i; j++){
		  			if(j==res+1) break;
		  				...
		  				if(userInven.existCard(j, userID) == 1 && hence <2){
		  					%>
		  					<img src="/boardprj/img/num=<%=j%>_exist=1.jpg" width=239px	height=318px>
		  					<%
		  				}
		  		...
		  		for(int j=(1+((i-1)*4))+10000;j<=4*i+10000; j++){
		  			...
		  			if(j==res+1+10000) break;
		  				...
		  				if(userInven.existCard(j, userID) == 1 && hence==1){
		  					...
		  					%>
		  					<img src="/boardprj/img/num=<%=j%>_exist=1_hence=2.jpg" width=239px	height=318px>
		  					<%
		  				}
		  				else if(userInven.existCard(j, userID) == 1 && hence==3){
		  					%>
		  					<img src="/boardprj/img/num=<%=j%>_exist=1_hence=3.jpg" width=239px	height=318px>
		  					<%
		  				}
		  				else{
		  					%>
